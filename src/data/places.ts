...
export const PLACES: Place[] = [
  ...
  { id: "celeste",       name: "Celeste",          category: "bars", lat: 37.7970, lng: -122.4349, note: "2165 Union St" },
  ...
  { id: "native-twins",      name: "Native Twins",          category: "cappuccinos", lat: 37.7916, lng: -122.4274, note: "top of Lafayette Park", addedAt: "2026-05-19" },
